...
const YOUTUBE_API_KEY = "AIzaSyCbpTgZXjR2oba74oRppHKFKFbRuyPFaZY";
...
const defaultVideoCats = {
  ...
  description:
    "Happy Cats Compilation - Cutest Cat Ever 2018 Plea…te Videos: Cute Animal, Cute Dog, Cat and Babies.",
