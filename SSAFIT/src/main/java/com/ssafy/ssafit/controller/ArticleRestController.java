...
public class ArticleRestController {
	...
	public ResponseEntity<?> likeForProgram(@RequestBody User user,@PathVariable int article_id, int like_property){
		int result = articleService.likeArticle(user, article_id, like_property);
